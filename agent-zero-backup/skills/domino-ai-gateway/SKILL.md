...
description: "Access external LLM providers through Domino AI Gateway - a secure proxy with centralized API key management, usage monitoring, and compliance. Supports OpenAI, AWS Bedrock, Azure OpenAI, Anthropic, and more."
version: "1.0.0"
author: "Domino Data Lab / Tolu"
tags: ["domino", "mlops", "ai-gateway", "llm", "openai", "bedrock", "anthropic", "proxy"]
trigger_patterns:
  - "domino ai gateway"
  - "domino llm access"
  - "access openai from domino"
  - "configure ai gateway endpoint"
  - "domino llm proxy"
  - "monitor llm usage"
  - "domino openai bedrock"
---

# Domino AI Gateway Skill

Access external LLM providers through Domino AI Gateway — a secure proxy with centralized API key management, usage monitoring, and compliance.
...
3. View metrics: request count, token usage, response times, error rates
...
AI Gateway tracks token usage per user, project, endpoint, and time period.
