# Fuzzing and CI gates

Fuzz seeds, amounts, authorities, account order, discriminators, oracle values, and boundary amounts. CI should run format, build, tests, and security checks.
