# LiteSVM and Mollusk test strategy

Use LiteSVM for fast local runtime tests needing accounts and banks. Use Mollusk v0.13.4 for isolated instruction tests with explicit account vectors and no full validator.
