...
Micro-AKT, the smallest denomination of the native staking token:

```
1 AKT = 1,000,000 uakt
```

Used for staking, governance, and gas fees. Not used directly for deployment pricing since Mainnet 17.

### uact

Akash Compute Token (ACT) in micro-denomination. USD-pegged (~$1 of compute credit). Used for all deployment payments since Mainnet 17 (March 2026) via the Burn-Mint Equilibrium model.
...
1000 uact × 438,000 = 438,000,000 uact = 438 ACT ≈ $438 USD
```
