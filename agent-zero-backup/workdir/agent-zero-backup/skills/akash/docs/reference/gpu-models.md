...
| `b100` | 192GB HBM3e | Blackwell | Large model training, HPC |
| `b200` | 192GB HBM3e | Blackwell | Large model training, HPC |
...
| `rtx5070` | 12GB GDDR7 | Blackwell | ML inference, gaming |
| `rtx5080` | 16GB GDDR7 | Blackwell | ML training, inference |
| `rtx5090` | 32GB GDDR7 | Blackwell | Training, inference |
