...
| Chain ID | `akashnet-2` |
| Native Token | AKT |
| Deployment Denom | uact (1 ACT = 1,000,000 uact, ~$1 peg) |
| Staking Denom | uakt (1 AKT = 1,000,000 uakt) |
...
Akash is exploring **shared security models** (AEP-79) for enhanced network security:

- Investigating integration with Cosmos shared security (replicated security)
- Goal: Allow Akash to leverage the security of larger Cosmos chains
- Would reduce the cost of securing the network independently
- Enable more resources to be directed toward ecosystem development
- Status: Research and community discussion phase

For the latest updates, follow the [Akash Enhancement Proposals](https://github.com/akash-network/akash-node-mainnet/tree/main/proposals).
