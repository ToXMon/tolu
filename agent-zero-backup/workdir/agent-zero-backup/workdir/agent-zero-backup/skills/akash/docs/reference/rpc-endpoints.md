...
> **Note:** Testnet and sandbox endpoints change frequently. Check [github.com/akash-network/net](https://github.com/akash-network/net) for current testnet configuration, including chain-id, RPC endpoints, and seed nodes. The sandbox chain-id may differ from what is listed above.
